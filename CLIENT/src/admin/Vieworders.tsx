...
const Vieworders: React.FC = () => {
  ...
  const getOrder = async () => {
    try {
      ...
      const res = await axios.get<IOrderResponse>("https://lucidmerch.onrender.com/api/v1/orders/getallorders");
  ...
  const updateOrderStatus = async (orderId: string, status: string) => {
    try {
      await axios.put(`https://lucidmerch.onrender.com/api/v1/orders/updateorderstatus/${orderId}`, { status });
